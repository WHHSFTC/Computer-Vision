...
def runPipeline(image, llrobot):
    ...
    lower_hsv1 = COLOR_BOUNDS['red1'][0]
    upper_hsv1 = COLOR_BOUNDS['red1'][1]
    lower_hsv2 = COLOR_BOUNDS['red2'][0]
    upper_hsv2 = COLOR_BOUNDS['red2'][1]
    kernel = np.ones((9,9), dtype=np.uint8)
    img_threshold1 = cv2.inRange(img_hsv, lower_hsv1, upper_hsv1)
    img_threshold2 = cv2.inRange(img_hsv, lower_hsv2, upper_hsv2)
